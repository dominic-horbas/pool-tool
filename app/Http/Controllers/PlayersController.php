...
class PlayersController extends Controller
{
    ...
    public function index()
    {
        ...
        $poolersCount = Pooler::all()->count();

        $forwards = Skater::where(['position_id' => 1, 'pooler_id' => null])->limit(50)->get();
        $data['forwards'] = $forwards->sortByDesc('points_pool');
        ...
        $data['defense'] = $defense->sortByDesc('points_pool');
        ...
        $data['goalers'] = $goalers->sortByDesc('points_pool');
        ...
        $data['skatersTypeahead'] = Skater::where(['pooler_id' => null])->get()->toJson();
